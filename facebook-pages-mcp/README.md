...
The separate [Facebook Content Studio skill](https://github.com/MTEnt/special-skills/tree/main/plugins/facebook-content-studio) can prepare validated post packages and hand supported text, link, and photo posts to this server's approval flow.
